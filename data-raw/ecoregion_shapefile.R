...
eco_shape <- st_read("data-raw",
                         layer = "shape_eco_simplified")

eco_shape <- filter(eco_shape, Ecoregion %in% c("Azores", "Baltic Sea", "Barents Sea", "Bay of Biscay and the Iberian Coast", "Celtic Seas", "Faroes", "Greater North Sea", "Greenland Sea", "Icelandic Waters", "Norwegian Sea", "Oceanic Northeast Atlantic"))
